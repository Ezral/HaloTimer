...
./gradlew :app:connectedDebugAndroidTest --no-daemon --stacktrace \
  ...
  -Pandroid.testInstrumentationRunnerArguments.class=com.ezral.halo.HaloRepeatEditorTest,com.ezral.halo.HaloUpgradeTest,com.ezral.halo.HaloSmokeTest,com.ezral.halo.HaloFullScreenTest
halo_test_result=$?
