...
./gradlew :app:connectedDebugAndroidTest --no-daemon --stacktrace \
  ...
  -Pandroid.testInstrumentationRunnerArguments.class=com.ezral.halo.HaloAudioTest,com.ezral.halo.HaloPresetTest,com.ezral.halo.HaloRepeatEditorTest,com.ezral.halo.HaloUpgradeTest,com.ezral.halo.HaloSmokeTest,com.ezral.halo.HaloFullScreenTest,com.ezral.halo.HaloPerimeterTest
halo_test_result=$?
